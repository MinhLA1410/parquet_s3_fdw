...
--Testcase 896:
SELECT * from ft1 where (v->>'c1')::int8 < 1; -- ERROR
--Testcase 897:
INSERT INTO ft1 (v) VALUES (json_build_object('c1', 1)); -- ERROR
--Testcase 898:
DELETE FROM ft1 WHERE (v->>'c1')::int8 = 1; -- ERROR
--Testcase 899:
TRUNCATE ft1; -- ERROR
--Testcase 900:
...
--Testcase 53:
EXPLAIN (VERBOSE, COSTS OFF) SELECT * FROM ft1 t1 WHERE (v->>'c3')::int8 IS NULL;        -- NullTest
--Testcase 54:
EXPLAIN (VERBOSE, COSTS OFF) SELECT * FROM ft1 t1 WHERE (v->>'c3')::int8 IS NOT NULL;    -- NullTest
--Testcase 55:
...
--Testcase 726:
EXPLAIN (VERBOSE, COSTS OFF)
SELECT (t1.v->>'c2')::int FROM ft1 t1 WHERE (t1.v->>'c1')::int > 960 ORDER BY (t1.v->>'c2')::int FETCH FIRST 2 ROWS WITH TIES;
--Testcase 727:
SELECT (t1.v->>'c2')::int FROM ft1 t1 WHERE (t1.v->>'c1')::int > 960 ORDER BY (t1.v->>'c2')::int FETCH FIRST 2 ROWS WITH TIES;
...
--Testcase 728:
EXPLAIN (VERBOSE, COSTS OFF)
	SELECT * FROM ft2 ORDER BY ft2.v->>'c1', random();
--Testcase 729:
EXPLAIN (VERBOSE, COSTS OFF)
	SELECT * FROM ft2 ORDER BY ft2.v->>'c1', ft2.v->>'c3' collate "C";
...
EXPLAIN (VERBOSE, COSTS OFF)
SELECT * FROM (
    SELECT 1 AS type,(ft1.v->>'c1')::int4 as c1 FROM ft1
    UNION ALL
    SELECT 2 AS type,(ft2.v->>'c1')::int4 as c1 FROM ft2
) a ORDER BY type,c1;
...
-- parquet_s3_fdw does not support JOIN pushdown
-- SEMI JOIN
--Testcase 147:
EXPLAIN (VERBOSE, COSTS OFF)
...
-- parquet_s3_fdw does not support pushdown join
--Testcase 151:
EXPLAIN (VERBOSE, COSTS OFF)
...
--Testcase 744:
EXPLAIN (verbose, costs off)
SELECT (ft2.v->>'c1')::int4 as c1, (ft2.v->>'c2')::int4 as c2, (ft2.v->>'c3') as c3, (ft2.v->>'c4'), (ft2.v->>'c5'), (ft2.v->>'c6'), (ft2.v->>'c7'), (ft2.v->>'c8'),
       (ft4.v->>'c1')::int4 as c1, (ft4.v->>'c2')::int4 as c2, (ft4.v->>'c3') as c3
  FROM ft2 INNER JOIN ft4 ON (ft2.v->>'c2')::int4 = (ft4.v->>'c1')::int4
  WHERE (ft2.v->>'c1')::int4 > 900
  AND EXISTS (SELECT 1 FROM ft5 WHERE (ft4.v->>'c1')::int4 = (ft5.v->>'c1')::int4)
  ORDER BY (ft2.v->>'c1')::int4;
--Testcase 745:
SELECT (ft2.v->>'c1')::int4 as c1, (ft2.v->>'c2')::int4 as c2, (ft2.v->>'c3') as c3, (ft2.v->>'c4'), (ft2.v->>'c5'), (ft2.v->>'c6'), (ft2.v->>'c7'), (ft2.v->>'c8'),
       (ft4.v->>'c1')::int4 as c1, (ft4.v->>'c2')::int4 as c2, (ft4.v->>'c3') as c3
  FROM ft2 INNER JOIN ft4 ON (ft2.v->>'c2')::int4 = (ft4.v->>'c1')::int4
...
--Testcase 746:
EXPLAIN (verbose, costs off)
SELECT (ft2.v->>'c1'), (ft2.v->>'c2'), (ft2.v->>'c3'), (ft2.v->>'c4'), (ft2.v->>'c5'), (ft2.v->>'c6'), (ft2.v->>'c7'), (ft2.v->>'c8'),
       ft4.*
  FROM ft2 INNER JOIN
  (SELECT (ft4.v->>'c1')::int4 as c1, (ft4.v->>'c2') as c2, (ft4.v->>'c3') as c3 FROM ft4 WHERE
  EXISTS (SELECT 1 FROM ft5 WHERE (ft4.v->>'c1')::int4 = (ft5.v->>'c1')::int4)) ft4
  ON (ft2.v->>'c2')::int4 = ft4.c1
  WHERE (ft2.v->>'c1')::int4 > 900
  ORDER BY (ft2.v->>'c1')::int4;
--Testcase 747:
SELECT (ft2.v->>'c1'), (ft2.v->>'c2'), (ft2.v->>'c3'), (ft2.v->>'c4'), (ft2.v->>'c5'), (ft2.v->>'c6'), (ft2.v->>'c7'), (ft2.v->>'c8'),
...
SELECT (ft2.v->>'c1'), (ft2.v->>'c2'), (ft2.v->>'c3'), (ft2.v->>'c4'), (ft2.v->>'c5'), (ft2.v->>'c6'), (ft2.v->>'c7'), (ft2.v->>'c8'),
       ft4.*
  FROM ft2 LEFT JOIN
  (SELECT (ft4.v->>'c1')::int4 as c1, (ft4.v->>'c2'), (ft4.v->>'c3') FROM ft4 WHERE
  EXISTS (SELECT 1 FROM ft5 WHERE (ft4.v->>'c1')::int4 = (ft5.v->>'c1')::int4)) ft4
  ON (ft2.v->>'c2')::int4 = ft4.c1
  WHERE (ft2.v->>'c1')::int4 > 900
  ORDER BY (ft2.v->>'c1')::int4 LIMIT 10;
--Testcase 749:
SELECT (ft2.v->>'c1'), (ft2.v->>'c2'), (ft2.v->>'c3'), (ft2.v->>'c4'), (ft2.v->>'c5'), (ft2.v->>'c6'), (ft2.v->>'c7'), (ft2.v->>'c8'),
       ft4.*
  FROM ft2 LEFT JOIN
...
SELECT (ft2.v->>'c1'), (ft2.v->>'c2'), (ft2.v->>'c3'), (ft2.v->>'c4'), (ft2.v->>'c5'), (ft2.v->>'c6'), (ft2.v->>'c7'), (ft2.v->>'c8'),
  ...
  EXISTS (SELECT 1 FROM ft5 WHERE (ft4.v->>'c1')::int4 = (ft5.v->>'c1')::int4)) ft4
  ON (ft2.v->>'c2')::int4 = ft4.c1
  INNER JOIN (SELECT (ft5.v->>'c1')::int4 as c1, (ft5.v->>'c2'), (ft5.v->>'c3') FROM ft5 WHERE
  EXISTS (SELECT 1 FROM ft4 WHERE (ft4.v->>'c1')::int4 = (ft5.v->>'c1')::int4)) ft5
  ON (ft2.v->>'c2')::int4 <= ft5.c1
  WHERE (ft2.v->>'c1')::int4 > 900
  ORDER BY (ft2.v->>'c1')::int4 LIMIT 10;
--Testcase 751:
SELECT (ft2.v->>'c1'), (ft2.v->>'c2'), (ft2.v->>'c3'), (ft2.v->>'c4'), (ft2.v->>'c5'), (ft2.v->>'c6'), (ft2.v->>'c7'), (ft2.v->>'c8'),
...
--Testcase 752:
EXPLAIN (verbose, costs off)
SELECT (ft2.v->>'c1') as c1, (ft2.v->>'c2'), (ft2.v->>'c3'), (ft2.v->>'c4'), (ft2.v->>'c5'), (ft2.v->>'c6'), (ft2.v->>'c7'), (ft2.v->>'c8') FROM ft2 WHERE
  (ft2.v->>'c1')::int4 = ANY (
	SELECT (ft2.v->>'c1')::int4 FROM ft2 WHERE
	  EXISTS (SELECT 1 FROM ft4 WHERE (ft4.v->>'c2')::int4 = (ft2.v->>'c2')::int4))
  AND (ft2.v->>'c1')::int4 > 900
  ORDER BY (ft2.v->>'c1')::int4 LIMIT 10;
--Testcase 753:
SELECT (ft2.v->>'c1') as c1, (ft2.v->>'c2'), (ft2.v->>'c3'), (ft2.v->>'c4'), (ft2.v->>'c5'), (ft2.v->>'c6'), (ft2.v->>'c7'), (ft2.v->>'c8') FROM ft2 WHERE
  (ft2.v->>'c1')::int4 = ANY (
...
--Testcase 754:
EXPLAIN (verbose, costs off)
SELECT (ftupper.v->>'c1'), (ftupper.v->>'c2'), (ftupper.v->>'c3'), (ftupper.v->>'c4'), (ftupper.v->>'c5'), (ftupper.v->>'c6'), (ftupper.v->>'c7'), (ftupper.v->>'c8') FROM ft2 ftupper WHERE
   EXISTS (
	SELECT (ft2.v->>'c1')::int4 as c1 FROM ft2 WHERE
	  EXISTS (SELECT 1 FROM ft4 WHERE (ft4.v->>'c2')::int4 = (ft2.v->>'c2')::int4) AND (ft2.v->>'c1')::int4 = (ftupper.v->>'c1')::int4 )
  AND (ftupper.v->>'c1')::int4 > 900
  ORDER BY (ftupper.v->>'c1')::int4 LIMIT 10;
--Testcase 755:
SELECT (ftupper.v->>'c1'), (ftupper.v->>'c2'), (ftupper.v->>'c3'), (ftupper.v->>'c4'), (ftupper.v->>'c5'), (ftupper.v->>'c6'), (ftupper.v->>'c7'), (ftupper.v->>'c8') FROM ft2 ftupper WHERE
   EXISTS (
	SELECT (ft2.v->>'c1')::int4 as c1 FROM ft2 WHERE
...
--Testcase 756:
EXPLAIN (verbose, costs off)
SELECT (ft2.v->>'c1'), (ft2.v->>'c2')::int4 as c2, (ft2.v->>'c3'), (ft2.v->>'c4'), (ft2.v->>'c5'), (ft2.v->>'c6'), (ft2.v->>'c7'), (ft2.v->>'c8'),
       ft4.*
  FROM ft2 INNER JOIN
	(SELECT (ft4.v->>'c1')::int4 as c1, (ft4.v->>'c2'), (ft4.v->>'c3') FROM ft4 WHERE EXISTS (
		SELECT 1 FROM ft2 WHERE (ft2.v->>'c2')::int4 = (ft4.v->>'c2')::int4)) ft4
	ON (ft2.v->>'c2')::int4 = ft4.c1
	INNER JOIN
	(SELECT (ft2.v->>'c1'), (ft2.v->>'c2')::int4 as c2, (ft2.v->>'c3'), (ft2.v->>'c4'), (ft2.v->>'c5'), (ft2.v->>'c6'), (ft2.v->>'c7'), (ft2.v->>'c8')
    FROM ft2 WHERE EXISTS (
		SELECT 1 FROM ft4 WHERE (ft2.v->>'c2')::int4 = (ft4.v->>'c2')::int4)) ft21
	ON (ft2.v->>'c2')::int4 = ft21.c2
	WHERE (ft2.v->>'c1')::int4 > 900
	ORDER BY (ft2.v->>'c1')::int4 LIMIT 10;
--Testcase 757:
SELECT (ft2.v->>'c1'), (ft2.v->>'c2')::int4 as c2, (ft2.v->>'c3'), (ft2.v->>'c4'), (ft2.v->>'c5'), (ft2.v->>'c6'), (ft2.v->>'c7'), (ft2.v->>'c8'),
...
--Testcase 758:
EXPLAIN (verbose, costs off)
SELECT (ft1.v->>'c1')::int4 as c1 FROM ft1 JOIN ft2 on (ft1.v->>'c1')::int4 = (ft2.v->>'c1')::int4 WHERE
	(ft1.v->>'c1')::int4 IN (
		SELECT (ft2.v->>'c1')::int4 FROM ft2 JOIN ft4 ON (ft2.v->>'c1')::int4 = (ft4.v->>'c1')::int4)
	ORDER BY (ft1.v->>'c1')::int4 LIMIT 5;
...
-- change (bug #17889)
--Testcase 901:
\set var :PATH_FILENAME'/ported_postgres/loct1_1.parquet'
CREATE FOREIGN TABLE loct1_nonsc (c1 int OPTIONS (key 'true')) SERVER parquet_s3_srv OPTIONS (filename :'var');
CREATE FOREIGN TABLE loct1 (v jsonb) SERVER parquet_s3_srv OPTIONS (filename :'var', key_columns 'c1', schemaless 'true');
--Testcase 902:
INSERT INTO loct1_nonsc VALUES (1001);
--Testcase 903:
INSERT INTO loct1_nonsc VALUES (1002);
--Testcase 904:
\set var :PATH_FILENAME'/ported_postgres/loct2_1.parquet'
--Testcase 905:
CREATE FOREIGN TABLE remt2_nonsc (c1 int OPTIONS (key 'true'), c2 text) SERVER parquet_s3_srv OPTIONS (filename :'var');
--Testcase 922:
CREATE FOREIGN TABLE remt2 (v jsonb) SERVER parquet_s3_srv OPTIONS (filename :'var', key_columns 'c1', schemaless 'true');
--Testcase 906:
INSERT INTO remt2_nonsc SELECT id, to_char(id, 'FM0000') FROM generate_series(1, 1000) id;
--Testcase 907:
INSERT INTO remt2_nonsc VALUES (1001, 'foo');
--Testcase 908:
INSERT INTO remt2_nonsc VALUES (1002, 'bar');
--Testcase 909:
-- ANALYZE loct1;
-- ANALYZE remt2;
--Testcase 910:
...
EXPLAIN (VERBOSE, COSTS OFF)
--Testcase 914:
UPDATE remt2 SET v = json_build_object('c2', (remt2.v->>'c2')::text || (remt2.v->>'c2')::text) FROM loct1 WHERE (loct1.v->>'c1')::int = (remt2.v->>'c1')::int;
--Testcase 915:
UPDATE remt2 SET v = json_build_object('c2', (remt2.v->>'c2')::text || (remt2.v->>'c2')::text) FROM loct1 WHERE (loct1.v->>'c1')::int = (remt2.v->>'c1')::int;
--Testcase 916:
SELECT * FROM remt2 WHERE (v->>'c1')::int > 1000;
--Testcase 917:
...
-- -- Here is testcase from query_cancel.sql from postgres_fdw
