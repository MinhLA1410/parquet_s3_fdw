...
-- parquet_s3_fdw doese not support pushdown join
-- SEMI JOIN
--Testcase 147:
EXPLAIN (VERBOSE, COSTS OFF)
...
--Testcase 164:
SELECT t1."C 1" FROM "S 1"."T1" t1, LATERAL (SELECT DISTINCT t2.c1, t3.c1 FROM ft1 t2, ft2 t3 WHERE t2.c1 = t3.c1 AND t2.c2 = t1.c2) q ORDER BY t1."C 1" OFFSET 10 LIMIT 10;
-- still no pushdown pseudoconstant because not pushdown join
...
CREATE FOREIGN TABLE loct1 (c1 int OPTIONS (key 'true')) SERVER parquet_s3_srv OPTIONS (filename :'var');
--Testcase 902:
...
--Testcase 905:
CREATE FOREIGN TABLE remt2 (c1 int OPTIONS (key 'true'), c2 text) SERVER parquet_s3_srv OPTIONS (filename :'var');
--Testcase 906:
INSERT INTO remt2 SELECT id, to_char(id, 'FM0000') FROM generate_series(1, 1000) id;
--Testcase 907:
INSERT INTO remt2 VALUES (1001, 'foo');
--Testcase 908:
INSERT INTO remt2 VALUES (1002, 'bar');
--Testcase 909:
-- ANALYZE loct1;
-- ANALYZE remt2;
--Testcase 910:
...
UPDATE remt2 SET c2 = remt2.c2 || remt2.c2 FROM loct1 WHERE loct1.c1 = remt2.c1;
--Testcase 916:
SELECT * FROM remt2 WHERE c1 > 1000;
--Testcase 917:
